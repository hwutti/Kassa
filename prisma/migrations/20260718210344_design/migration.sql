...
CREATE TABLE "new_Einstellung" (
    ...
    "design" TEXT NOT NULL DEFAULT 'dunkel',
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_Einstellung" ("id", "logoHoehe", "logoUrl", "titel", "untertitel", "updatedAt") SELECT "id", "logoHoehe", "logoUrl", "titel", "untertitel", "updatedAt" FROM "Einstellung";
